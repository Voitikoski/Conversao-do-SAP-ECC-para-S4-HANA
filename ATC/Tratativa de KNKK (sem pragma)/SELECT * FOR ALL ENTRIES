*--> 27/11/2023 - Migração S4 -FV
*    SELECT *
*      FROM knkk
*      INTO TABLE t_knkk
*       FOR ALL ENTRIES IN t_kna1_aux
*     WHERE kunnr = t_kna1_aux-kunnr AND
*           kkber = p_kkber.
        ...
        LOOP AT t_kna1_aux INTO DATA(w_for_all_54).
          w_data_where_68-kunnr = w_for_all_54-kunnr.
